...
CREATE SEQUENCE IF NOT EXISTS SEQUENCE_END_ENDERECO ;

CREATE TABLE IF NOT EXISTS END_ENDERECO(
    end_id INTEGER PRIMARY KEY DEFAULT NEXTVAL('SEQUENCE_END_ENDERECO'),
...
CREATE SEQUENCE IF NOT EXISTS SEQUENCE_PAS_PESSOA ;

CREATE TABLE IF NOT EXISTS PSA_PESSOA(
	psa_id INTEGER PRIMARY KEY DEFAULT NEXTVAL('SEQUENCE_PAS_PESSOA'),
